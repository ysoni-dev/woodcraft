  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-table"></i>Product List</h3>
            <ol class="breadcrumb">
              ...
              <table class="table table-striped table-advance table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>${i.qty}</td>
                    <td>${i.price}</td>
                    <td><img src=${i.img} height="100px" width="100px"></td>
                    <td>
                      <div class="btn-group">
                        <a class="btn btn-primary" href="AProduct.jsp"><i class="icon_plus_alt2"></i></a>
                     <a class="btn btn-success" href="UpdateProduct.jsp?update=${i.productId}"><img src="img/icons8-available-updates-16.png"></a>
                        <a class="btn btn-danger" href="DeleteProduct?productId=${i.productId}"><i class="icon_close_alt2"></i></a>
                      </div>
                    </td>
                  </tr>
