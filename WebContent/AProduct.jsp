      ...
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="Admin.jsp">Homew</a></li>
...
<div class="row" >
 <div class="col-lg-12" >
            ...
            <header  class="text-center" >
               ...
               <form class="form-validate form-horizontal" id="feedback_form" method="post" action="AddProduct"  enctype="multipart/form-data" style="border:none;">
                    <div class="form-group" style="border:none;">
                      <label for="formGroupExampleInput" class="control-label col-lg-2" style="color: white;"><b>Name</b></label>
                      <div class="col-lg-10">
                        <input class="form-control" id="cname" name="name" minlength="5" type="text" required style="background: transparent;" />
                      </div>
                    </div>
                    <div class="form-group" style="border:none;">
                   <label for="formGroupExampleInput" class="control-label col-lg-2" style="color: white;"><b>Description</b></label>
                      <div class="col-lg-10">
                        <input class="form-control" id="cname" name="desc" minlength="5" type="text" required style="background: transparent;" />
                      </div>
                    </div>
                    <div class="form-group" style="border:none;">
                      <label for="cname" class="control-label col-lg-2" style="color: white;"><b>Quantity</b></label>
                      <div class="col-lg-10">
                        <input class="form-control" id="cname" name="qty" minlength="5" type="number" required style="background: transparent;" />
                      </div>
                    </div>
                    <div class="form-group" style="border:none;">
                      <label for="cname" class="control-label col-lg-2" style="color: white;"><b>Price</b></label>
                      <div class="col-lg-10">
                        <input class="form-control" id="cname" name="price" minlength="5" type="number" required style="background: transparent;" />
                      </div>
                    </div>
...
List<Category> categoryList = cdao.getAllCategory(); %>
                     ...
                     <div class="col-lg-10">
                       <select id="inputState" class="form-control" name="category" style="background: transparent;">
	   ...
	   out.print("<option value='"+cat.getCatId()+"'>"+cat.getCatName()+"</option>");
                     ...
                     <div class="form-group" style="border:none;">
                      ...
                      <div class="col-lg-10">
                        <input class="form-control" id="images" name="image" minlength="5" type="file" required style="background: transparent;" />
                      </div>
                    </div>
