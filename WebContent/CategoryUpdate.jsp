...
<form class="text-center " action="UpdateCategory"  method="post" style="border: transparent;">
<% String str = request.getParameter("update"); 
	CategoryDao cdao = new CategoryDaoimpl(); 
	int dataid = Integer.parseInt(str.trim());
	Category cat = cdao.getCategoryById(dataid);%> 
	<br><br>
...
<br>
    ...
    <!-- Name -->
        <input type="hidden" id="defaultSubscriptionFormPassword" class="form-control mb-4" name="id" placeholder="Name" value=<%=cat.getCatId() %> style="background: transparent; color: black;">
    
    <label for="formGroupExampleInput" style="float: left;">Category Name</label>
    <input type="text" id="defaultSubscriptionFormPassword" class="form-control mb-4" name="name" placeholder="Name" value=<%=cat.getCatName() %> style="background: transparent; color: black;">
    <label for="formGroupExampleInput" style="float: left;">Description here</label>
   
    <input type="text" id="defaultSubscriptionFormEmail" class="form-control mb-4" name="desc" placeholder="Desc" value=<%=cat.getCatDesc() %> style="background: transparent;">
